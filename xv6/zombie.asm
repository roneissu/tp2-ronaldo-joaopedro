...
strcmp(const char *p, const char *q)
{
  ...
  71:	84 c0                	test   %al,%al
  73:	74 22                	je     97 <strcmp+0x37>
  75:	38 d8                	cmp    %bl,%al
  77:	74 0d                	je     86 <strcmp+0x26>
  79:	eb 1e                	jmp    99 <strcmp+0x39>
  7b:	90                   	nop
  7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  80:	38 d8                	cmp    %bl,%al
  82:	89 f1                	mov    %esi,%ecx
  84:	75 13                	jne    99 <strcmp+0x39>
    p++, q++;
  86:	83 c2 01             	add    $0x1,%edx
  while(*p && *p == *q)
  89:	0f b6 02             	movzbl (%edx),%eax
    p++, q++;
  8c:	8d 71 01             	lea    0x1(%ecx),%esi
  while(*p && *p == *q)
...
free(void *ap)
{
 ...
 5a1:	a1 cc 09 00 00       	mov    0x9cc,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 cc 09 00 00       	mov    %eax,0x9cc
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 cc 09 00 00       	mov    %eax,0x9cc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 cc 09 00 00    	mov    0x9cc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 cc 09 00 00    	mov    %edx,0x9cc
}
 ...
 6e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 cc 09 00 00 d0 	movl   $0x9d0,0x9cc
 6f7:	09 00 00 
 6fa:	c7 05 d0 09 00 00 d0 	movl   $0x9d0,0x9d0
 701:	09 00 00 
    base.s.size = 0;
 704:	b8 d0 09 00 00       	mov    $0x9d0,%eax
 709:	c7 05 d4 09 00 00 00 	movl   $0x0,0x9d4
 710:	00 00 00 
