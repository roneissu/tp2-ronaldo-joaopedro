...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      27:	e8 16 0d 00 00       	call   d42 <open>
...
fork1(void)
{
  ...
  pid = fork();
      41:	e8 b4 0c 00 00       	call   cfa <fork>
  if(pid == -1)
    ...
    wait();
      4f:	e8 b6 0c 00 00       	call   d0a <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
  ...
  pid = fork();
      7c:	e8 79 0c 00 00       	call   cfa <fork>
  if(pid == -1)
    ...
    panic("fork");
      ...
      96:	50                   	push   %eax
      97:	e8 8e 0c 00 00       	call   d2a <close>
      break;
      9c:	83 c4 10             	add    $0x10,%esp
      9f:	eb b3                	jmp    54 <main+0x54>
  exit();
      a1:	e8 5c 0c 00 00       	call   d02 <exit>
      runcmd(parsecmd(buf));
...
00000150 <panic>:
{
  ...
  exit();
     165:	e8 98 0b 00 00       	call   d02 <exit>
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exit();
     1b8:	e8 45 0b 00 00       	call   d02 <exit>
  pid = fork();
     1bd:	e8 38 0b 00 00       	call   cfa <fork>
  if(pid == -1)
    ...
    close(rcmd->fd);
     ...
     1e0:	e8 45 0b 00 00       	call   d2a <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     1e5:	59                   	pop    %ecx
     1e6:	58                   	pop    %eax
     1e7:	ff 73 10             	pushl  0x10(%ebx)
     1ea:	ff 73 08             	pushl  0x8(%ebx)
     1ed:	e8 50 0b 00 00       	call   d42 <open>
  ...
  pid = fork();
     237:	e8 be 0a 00 00       	call   cfa <fork>
  if(pid == -1)
    ...
    close(p[0]);
     ...
     24b:	e8 da 0a 00 00       	call   d2a <close>
    close(p[1]);
     250:	58                   	pop    %eax
     251:	ff 75 f4             	pushl  -0xc(%ebp)
     254:	e8 d1 0a 00 00       	call   d2a <close>
    wait();
     259:	e8 ac 0a 00 00       	call   d0a <wait>
    wait();
     25e:	e8 a7 0a 00 00       	call   d0a <wait>
    break;
     263:	83 c4 10             	add    $0x10,%esp
     266:	e9 4d ff ff ff       	jmp    1b8 <runcmd+0x48>
  pid = fork();
     26b:	e8 8a 0a 00 00       	call   cfa <fork>
  if(pid == -1)
    ...
    wait();
     27d:	e8 88 0a 00 00       	call   d0a <wait>
    runcmd(lcmd->right);
    ...
    panic("fork");
     ...
     2aa:	6a 00                	push   $0x0
     2ac:	e8 79 0a 00 00       	call   d2a <close>
      dup(p[0]);
     2b1:	5a                   	pop    %edx
     2b2:	ff 75 f0             	pushl  -0x10(%ebp)
     2b5:	e8 c0 0a 00 00       	call   d7a <dup>
      close(p[0]);
     2ba:	59                   	pop    %ecx
     2bb:	ff 75 f0             	pushl  -0x10(%ebp)
     2be:	e8 67 0a 00 00       	call   d2a <close>
      close(p[1]);
     2c3:	58                   	pop    %eax
     2c4:	ff 75 f4             	pushl  -0xc(%ebp)
     2c7:	e8 5e 0a 00 00       	call   d2a <close>
      runcmd(pcmd->right);
     2cc:	58                   	pop    %eax
     ...
     2e5:	6a 01                	push   $0x1
     2e7:	e8 3e 0a 00 00       	call   d2a <close>
      dup(p[1]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f4             	pushl  -0xc(%ebp)
     2f0:	e8 85 0a 00 00       	call   d7a <dup>
      close(p[0]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f0             	pushl  -0x10(%ebp)
     2f9:	e8 2c 0a 00 00       	call   d2a <close>
      close(p[1]);
     2fe:	58                   	pop    %eax
...
00000310 <fork1>:
{
  ...
  pid = fork();
     316:	e8 df 09 00 00       	call   cfa <fork>
  if(pid == -1)
...
execcmd(void)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     345:	6a 00                	push   $0x0
     347:	50                   	push   %eax
     348:	e8 13 08 00 00       	call   b60 <memset>
  cmd->type = EXEC;
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     375:	6a 00                	push   $0x0
     377:	50                   	push   %eax
     378:	e8 e3 07 00 00       	call   b60 <memset>
  cmd->type = REDIR;
  cmd->cmd = subcmd;
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     3c5:	6a 00                	push   $0x0
     3c7:	50                   	push   %eax
     3c8:	e8 93 07 00 00       	call   b60 <memset>
  cmd->type = PIPE;
  cmd->left = left;
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     405:	6a 00                	push   $0x0
     407:	50                   	push   %eax
     408:	e8 53 07 00 00       	call   b60 <memset>
  cmd->type = LIST;
  cmd->left = left;
...
backcmd(struct cmd *subcmd)
{
  ...
  memset(cmd, 0, sizeof(*cmd));
     ...
     445:	6a 00                	push   $0x0
     447:	50                   	push   %eax
     448:	e8 13 07 00 00       	call   b60 <memset>
  cmd->type = BACK;
  cmd->cmd = subcmd;
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 64 18 00 00       	push   $0x1864
     493:	e8 e8 06 00 00       	call   b80 <strchr>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 64 18 00 00       	push   $0x1864
     4e3:	e8 98 06 00 00       	call   b80 <strchr>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 5c 18 00 00       	push   $0x185c
     53c:	e8 3f 06 00 00       	call   b80 <strchr>
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 64 18 00 00       	push   $0x1864
     55b:	e8 20 06 00 00       	call   b80 <strchr>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 64 18 00 00       	push   $0x1864
     603:	e8 78 05 00 00       	call   b80 <strchr>
  ...
  *ps = s;
  ...
  return *s && strchr(toks, *s);
     ...
     621:	e8 5a 05 00 00       	call   b80 <strchr>
...
00000a50 <parsecmd>:
{
  ...
  es = s + strlen(s);
     ...
     a5b:	53                   	push   %ebx
     a5c:	e8 cf 00 00 00       	call   b30 <strlen>
  cmd = parseline(&s, es);
     a61:	59                   	pop    %ecx
  es = s + strlen(s);
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
     ...
     b03:	74 22                	je     b27 <strcmp+0x37>
     b05:	38 d8                	cmp    %bl,%al
     b07:	74 0d                	je     b16 <strcmp+0x26>
     b09:	eb 1e                	jmp    b29 <strcmp+0x39>
     b0b:	90                   	nop
     b0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     b10:	38 d8                	cmp    %bl,%al
     b12:	89 f1                	mov    %esi,%ecx
     b14:	75 13                	jne    b29 <strcmp+0x39>
    p++, q++;
     b16:	83 c2 01             	add    $0x1,%edx
  while(*p && *p == *q)
     b19:	0f b6 02             	movzbl (%edx),%eax
    p++, q++;
     b1c:	8d 71 01             	lea    0x1(%ecx),%esi
  while(*p && *p == *q)
     b1f:	0f b6 59 01          	movzbl 0x1(%ecx),%ebx
     b23:	84 c0                	test   %al,%al
     b25:	75 e9                	jne    b10 <strcmp+0x20>
     b27:	31 c0                	xor    %eax,%eax
  return (uchar)*p - (uchar)*q;
     b29:	29 d8                	sub    %ebx,%eax
}
     b2b:	5b                   	pop    %ebx
     b2c:	5e                   	pop    %esi
     b2d:	5d                   	pop    %ebp
     ...
     dc9:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
     ...
     e30:	e8 ed fe ff ff       	call   d22 <write>
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     ea0:	e8 7d fe ff ff       	call   d22 <write>
  ...
  write(fd, &c, 1);
     ...
     f01:	e8 1c fe ff ff       	call   d22 <write>
  ...
  write(fd, &c, 1);
     f1a:	e8 03 fe ff ff       	call   d22 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
     ...
     fb3:	57                   	push   %edi
     fb4:	53                   	push   %ebx
     fb5:	e8 68 fd ff ff       	call   d22 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    1007:	e8 16 fd ff ff       	call   d22 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    111e:	56                   	push   %esi
    111f:	e8 66 fc ff ff       	call   d8a <sbrk>
  if(p == (char*)-1)
