...
strcmp(const char *p, const char *q)
{
 ...
 133:	74 22                	je     157 <strcmp+0x37>
 135:	38 d8                	cmp    %bl,%al
 137:	74 0d                	je     146 <strcmp+0x26>
 139:	eb 1e                	jmp    159 <strcmp+0x39>
 13b:	90                   	nop
 13c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 140:	38 d8                	cmp    %bl,%al
 142:	89 f1                	mov    %esi,%ecx
 144:	75 13                	jne    159 <strcmp+0x39>
    p++, q++;
 146:	83 c2 01             	add    $0x1,%edx
  while(*p && *p == *q)
 149:	0f b6 02             	movzbl (%edx),%eax
    p++, q++;
 14c:	8d 71 01             	lea    0x1(%ecx),%esi
  while(*p && *p == *q)
 ...
 661:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 e8 0a 00 00    	cmp    %eax,0xae8
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 e8 0a 00 00 ec 	movl   $0xaec,0xae8
 7b7:	0a 00 00 
 7ba:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 ec 0a 00 00       	mov    $0xaec,%eax
 7c9:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 7d0:	00 00 00 
