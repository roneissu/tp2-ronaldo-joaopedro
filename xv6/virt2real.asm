...
main(int argc, char *argv[])
{
  ...
  1f:	e8 1c 00 00 00       	call   40 <func>
  
  exit();
  24:	e8 89 02 00 00       	call   2b2 <exit>
...
main(int argc, char *argv[])
{
  ...
  29:	50                   	push   %eax
  2a:	50                   	push   %eax
  2b:	68 44 07 00 00       	push   $0x744
  30:	ff 35 24 0a 00 00    	pushl  0xa24
  36:	e8 e5 03 00 00       	call   420 <printf>
    exit();
  3b:	e8 72 02 00 00       	call   2b2 <exit>
...
func(char* va)
{
  ...
  49:	e8 0c 03 00 00       	call   35a <virt2real>
  4e:	83 c4 0c             	add    $0xc,%esp
  51:	50                   	push   %eax
  52:	68 40 07 00 00       	push   $0x740
  57:	ff 35 24 0a 00 00    	pushl  0xa24
  5d:	e8 be 03 00 00       	call   420 <printf>

  return addreal;
}
  62:	a1 34 0a 00 00       	mov    0xa34,%eax
  67:	c9                   	leave  
  68:	c3                   	ret    
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 68 07 00 00 	movzbl 0x768(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 61 07 00 00       	mov    $0x761,%eax
