...
_forkcow:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  func_aux_2();
  11:	e8 0a 00 00 00       	call   20 <func_aux_2>
  
  exit();
  16:	e8 77 02 00 00       	call   292 <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
...
func_aux_2(void){
  ...
  printf(stdout, "%d\n", forkcow());
  26:	e8 1f 03 00 00       	call   34a <forkcow>
  2b:	83 ec 04             	sub    $0x4,%esp
  2e:	50                   	push   %eax
  2f:	68 20 07 00 00       	push   $0x720
  34:	ff 35 e8 09 00 00    	pushl  0x9e8
  3a:	e8 c1 03 00 00       	call   400 <printf>

  return pid;

}
  3f:	a1 f8 09 00 00       	mov    0x9f8,%eax
  44:	c9                   	leave  
  45:	c3                   	ret    
  46:	66 90                	xchg   %ax,%ax
  48:	66 90                	xchg   %ax,%ax
