   ...
   e:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  28:	ff 35 28 0a 00 00    	pushl  0xa28
  ...
  49:	ff 35 2c 0a 00 00    	pushl  0xa2c
  4f:	e8 ac 03 00 00       	call   400 <printf>

  exit();
  54:	83 c4 20             	add    $0x20,%esp
  57:	e8 46 02 00 00       	call   2a2 <exit>
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
strcmp(const char *p, const char *q)
{
  ...
  a1:	84 c0                	test   %al,%al
  a3:	74 22                	je     c7 <strcmp+0x37>
  a5:	38 d8                	cmp    %bl,%al
  a7:	74 0d                	je     b6 <strcmp+0x26>
  a9:	eb 1e                	jmp    c9 <strcmp+0x39>
  ab:	90                   	nop
  ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  b0:	38 d8                	cmp    %bl,%al
  b2:	89 f1                	mov    %esi,%ecx
  b4:	75 13                	jne    c9 <strcmp+0x39>
    p++, q++;
  b6:	83 c2 01             	add    $0x1,%edx
  while(*p && *p == *q)
  b9:	0f b6 02             	movzbl (%edx),%eax
    p++, q++;
  bc:	8d 71 01             	lea    0x1(%ecx),%esi
  while(*p && *p == *q)
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 84 07 00 00       	mov    $0x784,%ebx
        while(*s != 0){
