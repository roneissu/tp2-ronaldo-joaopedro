...
main(int argc, char *argv[])
{
  ...
  exit();
     10d:	e8 80 37 00 00       	call   3892 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 ac 37 00 00       	call   3902 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 74 37 00 00       	call   38e2 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 80 37 00 00       	call   3902 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 f0 5d 00 00    	pushl  0x5df0
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 f0 5d 00 00    	pushl  0x5df0
     1ae:	e8 3d 38 00 00       	call   39f0 <printf>
    exit();
     1b3:	e8 da 36 00 00       	call   3892 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 93 3d 00 00       	push   $0x3d93
     1bf:	ff 35 f0 5d 00 00    	pushl  0x5df0
     1c5:	e8 26 38 00 00       	call   39f0 <printf>
    exit();
     1ca:	e8 c3 36 00 00       	call   3892 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 77 3d 00 00       	push   $0x3d77
     1d6:	ff 35 f0 5d 00 00    	pushl  0x5df0
     1dc:	e8 0f 38 00 00       	call   39f0 <printf>
    exit();
     1e1:	e8 ac 36 00 00       	call   3892 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 56 3d 00 00       	push   $0x3d56
     1ed:	ff 35 f0 5d 00 00    	pushl  0x5df0
     1f3:	e8 f8 37 00 00       	call   39f0 <printf>
    exit();
     1f8:	e8 95 36 00 00       	call   3892 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 f0 5d 00 00    	pushl  0x5df0
     211:	e8 da 37 00 00       	call   39f0 <printf>
  pid = fork();
     216:	e8 6f 36 00 00       	call   388a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 c5 36 00 00       	call   38fa <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 b5 36 00 00       	call   3902 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     25c:	e8 81 36 00 00       	call   38e2 <unlink>
     261:	83 c4 10             	add    $0x10,%esp
     264:	85 c0                	test   %eax,%eax
     266:	78 28                	js     290 <exitiputtest+0x90>
    exit();
     268:	e8 25 36 00 00       	call   3892 <exit>
     26d:	8d 76 00             	lea    0x0(%esi),%esi
  wait();
     270:	e8 25 36 00 00       	call   389a <wait>
  printf(stdout, "exitiput test ok\n");
     275:	83 ec 08             	sub    $0x8,%esp
     278:	68 c6 3d 00 00       	push   $0x3dc6
     27d:	ff 35 f0 5d 00 00    	pushl  0x5df0
     ...
     298:	ff 35 f0 5d 00 00    	pushl  0x5df0
     29e:	e8 4d 37 00 00       	call   39f0 <printf>
      exit();
     2a3:	e8 ea 35 00 00       	call   3892 <exit>
    printf(stdout, "fork failed\n");
     2a8:	51                   	push   %ecx
     2a9:	51                   	push   %ecx
     2aa:	68 89 4c 00 00       	push   $0x4c89
     2af:	ff 35 f0 5d 00 00    	pushl  0x5df0
     2b5:	e8 36 37 00 00       	call   39f0 <printf>
    exit();
     2ba:	e8 d3 35 00 00       	call   3892 <exit>
      printf(stdout, "child chdir failed\n");
     2bf:	50                   	push   %eax
     2c0:	50                   	push   %eax
     2c1:	68 b2 3d 00 00       	push   $0x3db2
     2c6:	ff 35 f0 5d 00 00    	pushl  0x5df0
     2cc:	e8 1f 37 00 00       	call   39f0 <printf>
      exit();
     2d1:	e8 bc 35 00 00       	call   3892 <exit>
      printf(stdout, "mkdir failed\n");
     2d6:	52                   	push   %edx
     2d7:	52                   	push   %edx
     2d8:	68 48 3d 00 00       	push   $0x3d48
     2dd:	ff 35 f0 5d 00 00    	pushl  0x5df0
     2e3:	e8 08 37 00 00       	call   39f0 <printf>
      exit();
     2e8:	e8 a5 35 00 00       	call   3892 <exit>
...
000002f0 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     336:	e8 97 35 00 00       	call   38d2 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3a0:	e8 ed 34 00 00       	call   3892 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3a5:	51                   	push   %ecx
     3a6:	51                   	push   %ecx
     3a7:	68 ed 3d 00 00       	push   $0x3ded
     3ac:	ff 35 f0 5d 00 00    	pushl  0x5df0
     3b2:	e8 39 36 00 00       	call   39f0 <printf>
    exit();
     3b7:	e8 d6 34 00 00       	call   3892 <exit>
    printf(stdout, "fork failed\n");
     3bc:	52                   	push   %edx
     3bd:	52                   	push   %edx
     3be:	68 89 4c 00 00       	push   $0x4c89
     3c3:	ff 35 f0 5d 00 00    	pushl  0x5df0
     3c9:	e8 22 36 00 00       	call   39f0 <printf>
    exit();
     3ce:	e8 bf 34 00 00       	call   3892 <exit>
    printf(stdout, "unlink failed\n");
     3d3:	50                   	push   %eax
     3d4:	50                   	push   %eax
     3d5:	68 01 3e 00 00       	push   $0x3e01
     3da:	ff 35 f0 5d 00 00    	pushl  0x5df0
     3e0:	e8 0b 36 00 00       	call   39f0 <printf>
    exit();
     3e5:	e8 a8 34 00 00       	call   3892 <exit>
...
000003f0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     3fb:	ff 35 f0 5d 00 00    	pushl  0x5df0
  ...
  fd = open("echo", 0);
     ...
     40f:	e8 be 34 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     41e:	50                   	push   %eax
     41f:	e8 96 34 00 00       	call   38ba <close>
  fd = open("doesnotexist", 0);
     424:	5a                   	pop    %edx
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 45 3e 00 00       	push   $0x3e45
     42d:	e8 a0 34 00 00       	call   38d2 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     441:	ff 35 f0 5d 00 00    	pushl  0x5df0
    ...
    printf(stdout, "open echo failed!\n");
     ...
     458:	ff 35 f0 5d 00 00    	pushl  0x5df0
     45e:	e8 8d 35 00 00       	call   39f0 <printf>
    exit();
     463:	e8 2a 34 00 00       	call   3892 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     468:	50                   	push   %eax
     469:	50                   	push   %eax
     46a:	68 52 3e 00 00       	push   $0x3e52
     46f:	ff 35 f0 5d 00 00    	pushl  0x5df0
     475:	e8 76 35 00 00       	call   39f0 <printf>
    exit();
     47a:	e8 13 34 00 00       	call   3892 <exit>
     47f:	90                   	nop
...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     48d:	ff 35 f0 5d 00 00    	pushl  0x5df0
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4a4:	e8 29 34 00 00       	call   38d2 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4c0:	ff 35 f0 5d 00 00    	pushl  0x5df0
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4da:	56                   	push   %esi
     4db:	e8 d2 33 00 00       	call   38b2 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4f6:	56                   	push   %esi
     4f7:	e8 b6 33 00 00       	call   38b2 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     518:	ff 35 f0 5d 00 00    	pushl  0x5df0
     51e:	e8 cd 34 00 00       	call   39f0 <printf>
  close(fd);
     523:	89 34 24             	mov    %esi,(%esp)
     526:	e8 8f 33 00 00       	call   38ba <close>
  fd = open("small", O_RDONLY);
     52b:	5b                   	pop    %ebx
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 8f 3e 00 00       	push   $0x3e8f
     534:	e8 99 33 00 00       	call   38d2 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     54e:	ff 35 f0 5d 00 00    	pushl  0x5df0
  ...
  i = read(fd, buf, 2000);
     ...
     566:	53                   	push   %ebx
     567:	e8 3e 33 00 00       	call   38aa <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     582:	ff 35 f0 5d 00 00    	pushl  0x5df0
     588:	e8 63 34 00 00       	call   39f0 <printf>
  close(fd);
     58d:	89 1c 24             	mov    %ebx,(%esp)
     590:	e8 25 33 00 00       	call   38ba <close>
  if(unlink("small") < 0){
     595:	c7 04 24 8f 3e 00 00 	movl   $0x3e8f,(%esp)
     59c:	e8 41 33 00 00       	call   38e2 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5b0:	ff 35 f0 5d 00 00    	pushl  0x5df0
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     66d:	ff 35 f0 5d 00 00    	pushl  0x5df0
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     684:	e8 49 32 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6b3:	56                   	push   %esi
     6b4:	e8 f9 31 00 00       	call   38b2 <write>
  ...
  close(fd);
     ...
     6d5:	56                   	push   %esi
     6d6:	e8 df 31 00 00       	call   38ba <close>
  fd = open("big", O_RDONLY);
     6db:	5b                   	pop    %ebx
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 d7 3f 00 00       	push   $0x3fd7
     6e4:	e8 e9 31 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     724:	56                   	push   %esi
     725:	e8 80 31 00 00       	call   38aa <read>
    if(i == 0){
  ...
  close(fd);
     ...
     740:	56                   	push   %esi
     741:	e8 74 31 00 00       	call   38ba <close>
  if(unlink("big") < 0){
     746:	c7 04 24 d7 3f 00 00 	movl   $0x3fd7,(%esp)
     74d:	e8 90 31 00 00       	call   38e2 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     765:	ff 35 f0 5d 00 00    	pushl  0x5df0
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     841:	ff 35 f0 5d 00 00    	pushl  0x5df0
  ...
  name[2] = '\0';
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     876:	e8 57 30 00 00       	call   38d2 <open>
    close(fd);
     87b:	89 04 24             	mov    %eax,(%esp)
     87e:	e8 37 30 00 00       	call   38ba <close>
  for(i = 0; i < 52; i++){
  ...
  name[2] = '\0';
    ...
    unlink(name);
     ...
     8b1:	e8 2c 30 00 00       	call   38e2 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c6:	ff 35 f0 5d 00 00    	pushl  0x5df0
...
000008e0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     911:	e8 ec 2f 00 00       	call   3902 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     929:	e8 d4 2f 00 00       	call   3902 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     93d:	e8 a0 2f 00 00       	call   38e2 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     951:	ff 35 f0 5d 00 00    	pushl  0x5df0
    ...
    printf(stdout, "mkdir failed\n");
     ...
     968:	ff 35 f0 5d 00 00    	pushl  0x5df0
     96e:	e8 7d 30 00 00       	call   39f0 <printf>
    exit();
     973:	e8 1a 2f 00 00       	call   3892 <exit>
    printf(stdout, "unlink dir0 failed\n");
     978:	50                   	push   %eax
     979:	50                   	push   %eax
     97a:	68 41 40 00 00       	push   $0x4041
     97f:	ff 35 f0 5d 00 00    	pushl  0x5df0
     985:	e8 66 30 00 00       	call   39f0 <printf>
    exit();
     98a:	e8 03 2f 00 00       	call   3892 <exit>
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
     991:	68 30 40 00 00       	push   $0x4030
     996:	ff 35 f0 5d 00 00    	pushl  0x5df0
     99c:	e8 4f 30 00 00       	call   39f0 <printf>
    exit();
     9a1:	e8 ec 2e 00 00       	call   3892 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9a6:	51                   	push   %ecx
     9a7:	51                   	push   %ecx
     9a8:	68 1d 40 00 00       	push   $0x401d
     9ad:	ff 35 f0 5d 00 00    	pushl  0x5df0
     9b3:	e8 38 30 00 00       	call   39f0 <printf>
    exit();
     9b8:	e8 d5 2e 00 00       	call   3892 <exit>
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9cb:	ff 35 f0 5d 00 00    	pushl  0x5df0
     9d1:	e8 1a 30 00 00       	call   39f0 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 f4 5d 00 00       	push   $0x5df4
    ...
    printf(stdout, "exec echo failed\n");
     ...
     9f7:	ff 35 f0 5d 00 00    	pushl  0x5df0
     9fd:	e8 ee 2f 00 00       	call   39f0 <printf>
    exit();
     a02:	e8 8b 2e 00 00       	call   3892 <exit>
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     a4e:	e8 67 2e 00 00       	call   38ba <close>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a69:	e8 3c 2e 00 00       	call   38aa <read>
    ...
    close(fds[0]);
     ...
     ace:	e8 e7 2d 00 00       	call   38ba <close>
     ...
     afe:	e8 af 2d 00 00       	call   38b2 <write>
    ...
    exit();
     b1f:	e8 6e 2d 00 00       	call   3892 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b33:	e8 82 2d 00 00       	call   38ba <close>
    wait();
     b38:	e8 5d 2d 00 00       	call   389a <wait>
  printf(1, "pipe1 ok\n");
     b3d:	5a                   	pop    %edx
     b3e:	59                   	pop    %ecx
     ...
     b61:	e8 8a 2e 00 00       	call   39f0 <printf>
      exit();
     b66:	e8 27 2d 00 00       	call   3892 <exit>
    ...
    exit();
     b79:	e8 14 2d 00 00       	call   3892 <exit>
    ...
    exit();
     b8c:	e8 01 2d 00 00       	call   3892 <exit>
     ...
     b9a:	e8 51 2e 00 00       	call   39f0 <printf>
        exit();
     b9f:	e8 ee 2c 00 00       	call   3892 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid2 = fork();
     bd5:	e8 b0 2c 00 00       	call   388a <fork>
  if(pid2 == 0)
  ...
  pipe(pfds);
     ...
     be8:	50                   	push   %eax
     be9:	e8 b4 2c 00 00       	call   38a2 <pipe>
  pid3 = fork();
     bee:	e8 97 2c 00 00       	call   388a <fork>
  if(pid3 == 0){
  ...
  close(pfds[0]);
     ...
     c89:	e8 2c 2c 00 00       	call   38ba <close>
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
  ...
  wait();
     cc2:	e8 d3 2b 00 00       	call   389a <wait>
  wait();
     cc7:	e8 ce 2b 00 00       	call   389a <wait>
  wait();
     ccc:	e8 c9 2b 00 00       	call   389a <wait>
  printf(1, "preempt ok\n");
     cd1:	5e                   	pop    %esi
     cd2:	5f                   	pop    %edi
...
00000cf0 <exitwait>:
{
    ...
    if(pid){
     d00:	74 6f                	je     d71 <exitwait+0x81>
      if(wait() != pid){
     d02:	e8 93 2b 00 00       	call   389a <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d10:	e8 75 2b 00 00       	call   388a <fork>
    if(pid < 0){
  ...
  printf(1, "exitwait ok\n");
     ...
     d70:	c3                   	ret    
      exit();
     d71:	e8 1c 2b 00 00       	call   3892 <exit>
...
00000d80 <mem>:
{
  ...
  ppid = getpid();
     d97:	e8 76 2b 00 00       	call   3912 <getpid>
     d9c:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     d9e:	e8 e7 2a 00 00       	call   388a <fork>
    ...
    exit();
     e0f:	e8 7e 2a 00 00       	call   3892 <exit>
     ...
     e2a:	e8 93 2a 00 00       	call   38c2 <kill>
      exit();
     e2f:	e8 5e 2a 00 00       	call   3892 <exit>
     ...
     e3e:	5d                   	pop    %ebp
    wait();
     e3f:	e9 56 2a 00 00       	jmp    389a <wait>
...
00000e50 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e6c:	e8 71 2a 00 00       	call   38e2 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e71:	59                   	pop    %ecx
     e72:	5b                   	pop    %ebx
     e73:	68 02 02 00 00       	push   $0x202
     e78:	68 83 41 00 00       	push   $0x4183
     e7d:	e8 50 2a 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  pid = fork();
     e94:	e8 f1 29 00 00       	call   388a <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     eaf:	50                   	push   %eax
     eb0:	e8 3b 28 00 00       	call   36f0 <memset>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecd:	50                   	push   %eax
     ece:	56                   	push   %esi
     ecf:	e8 de 29 00 00       	call   38b2 <write>
  ...
  if(pid == 0)
    ...
    wait();
     ef6:	e8 9f 29 00 00       	call   389a <wait>
  close(fd);
  ...
  close(fd);
     ...
     f06:	e8 af 29 00 00       	call   38ba <close>
  fd = open("sharedfd", 0);
     f0b:	58                   	pop    %eax
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 83 41 00 00       	push   $0x4183
     f14:	e8 b9 29 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f3c:	e8 69 29 00 00       	call   38aa <read>
  ...
  close(fd);
     ...
     f7c:	e8 39 29 00 00       	call   38ba <close>
  unlink("sharedfd");
     f81:	c7 04 24 83 41 00 00 	movl   $0x4183,(%esp)
     f88:	e8 55 29 00 00       	call   38e2 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ff3:	c3                   	ret    
    exit();
     ff4:	e8 99 28 00 00       	call   3892 <exit>
    ...
    exit();
    1007:	e8 86 28 00 00       	call   3892 <exit>
    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    104e:	56                   	push   %esi
    104f:	e8 8e 28 00 00       	call   38e2 <unlink>
    pid = fork();
    1054:	e8 31 28 00 00       	call   388a <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1078:	e8 1d 28 00 00       	call   389a <wait>
  for(i = 0; i < 2; i++){
    107d:	31 ff                	xor    %edi,%edi
    wait();
    107f:	e8 16 28 00 00       	call   389a <wait>
    1084:	e8 11 28 00 00       	call   389a <wait>
    1089:	e8 0c 28 00 00       	call   389a <wait>
    ...
    109f:	e8 2e 28 00 00       	call   38d2 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10c0:	e8 e5 27 00 00       	call   38aa <read>
    ...
    10f8:	e8 bd 27 00 00       	call   38ba <close>
    if(total != 12*500){
    ...
    1112:	e8 cb 27 00 00       	call   38e2 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1151:	56                   	push   %esi
    1152:	e8 7b 27 00 00       	call   38d2 <open>
      if(fd < 0){
    ...
    1176:	e8 75 25 00 00       	call   36f0 <memset>
    ...
    118b:	56                   	push   %esi
    118c:	e8 21 27 00 00       	call   38b2 <write>
    ...
    119e:	75 de                	jne    117e <fourfiles+0x16e>
      exit();
    11a0:	e8 ed 26 00 00       	call   3892 <exit>
          printf(1, "wrong char\n");
    ...
    11af:	e8 3c 28 00 00       	call   39f0 <printf>
          exit();
    11b4:	e8 d9 26 00 00       	call   3892 <exit>
    ...
    11c2:	e8 29 28 00 00       	call   39f0 <printf>
        exit();
    11c7:	e8 c6 26 00 00       	call   3892 <exit>
      printf(1, "fork failed\n");
    11cc:	53                   	push   %ebx
    11cd:	53                   	push   %ebx
    ...
    11d5:	e8 16 28 00 00       	call   39f0 <printf>
      exit();
    11da:	e8 b3 26 00 00       	call   3892 <exit>
    ...
    11e8:	e8 03 28 00 00       	call   39f0 <printf>
      exit();
    11ed:	e8 a0 26 00 00       	call   3892 <exit>
    ...
    11fb:	e8 f0 27 00 00       	call   39f0 <printf>
          exit();
    1200:	e8 8d 26 00 00       	call   3892 <exit>
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    122a:	e8 5b 26 00 00       	call   388a <fork>
    if(pid < 0){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    wait();
    124d:	e8 48 26 00 00       	call   389a <wait>
    1252:	e8 43 26 00 00       	call   389a <wait>
    1257:	e8 3e 26 00 00       	call   389a <wait>
    125c:	e8 39 26 00 00       	call   389a <wait>
  name[0] = name[1] = name[2] = 0;
    ...
    1296:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1299:	e8 34 26 00 00       	call   38d2 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12bf:	50                   	push   %eax
    12c0:	e8 f5 25 00 00       	call   38ba <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    12f8:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fb:	e8 e2 25 00 00       	call   38e2 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1374:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    1377:	e8 56 25 00 00       	call   38d2 <open>
        if(fd < 0){
    ...
    1386:	50                   	push   %eax
    1387:	e8 2e 25 00 00       	call   38ba <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13a3:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13a6:	e8 37 25 00 00       	call   38e2 <unlink>
    ...
    13bb:	e8 30 26 00 00       	call   39f0 <printf>
            exit();
    13c0:	e8 cd 24 00 00       	call   3892 <exit>
    13c5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
    13c8:	e8 c5 24 00 00       	call   3892 <exit>
    ...
    13d8:	e8 13 26 00 00       	call   39f0 <printf>
        exit();
    13dd:	e8 b0 24 00 00       	call   3892 <exit>
          printf(1, "create failed\n");
    13e2:	51                   	push   %ecx
    13e3:	51                   	push   %ecx
    ...
    13eb:	e8 00 26 00 00       	call   39f0 <printf>
          exit();
    13f0:	e8 9d 24 00 00       	call   3892 <exit>
      printf(1, "fork failed\n");
    13f5:	53                   	push   %ebx
    13f6:	53                   	push   %ebx
    ...
    13fe:	e8 ed 25 00 00       	call   39f0 <printf>
      exit();
    1403:	e8 8a 24 00 00       	call   3892 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1419:	e8 d2 25 00 00       	call   39f0 <printf>
        exit();
    141e:	e8 6f 24 00 00       	call   3892 <exit>
...
00001430 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1450:	e8 7d 24 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    146c:	50                   	push   %eax
    146d:	e8 40 24 00 00       	call   38b2 <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 40 24 00 00       	call   38ba <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 35 42 00 00       	push   $0x4235
    1483:	e8 4a 24 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    149d:	e8 40 24 00 00       	call   38e2 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ba:	e8 13 24 00 00       	call   38d2 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    150b:	53                   	push   %ebx
    150c:	e8 a1 23 00 00       	call   38b2 <write>
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 98 23 00 00       	call   38ba <close>
  unlink("unlinkread");
    1522:	c7 04 24 35 42 00 00 	movl   $0x4235,(%esp)
    1529:	e8 b4 23 00 00       	call   38e2 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1554:	e8 39 23 00 00       	call   3892 <exit>
    ...
    exit();
    1567:	e8 26 23 00 00       	call   3892 <exit>
    ...
    exit();
    157a:	e8 13 23 00 00       	call   3892 <exit>
    ...
    exit();
    158d:	e8 00 23 00 00       	call   3892 <exit>
    ...
    exit();
    15a0:	e8 ed 22 00 00       	call   3892 <exit>
    ...
    exit();
    15b3:	e8 da 22 00 00       	call   3892 <exit>
    15b8:	90                   	nop
...
000015c0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1613:	50                   	push   %eax
    1614:	e8 99 22 00 00       	call   38b2 <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 8c 22 00 00       	call   38ba <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 fa 42 00 00       	push   $0x42fa
    1635:	68 f6 42 00 00       	push   $0x42f6
    163a:	e8 b3 22 00 00       	call   38f2 <link>
  ...
  unlink("lf1");
    ...
    1652:	e8 8b 22 00 00       	call   38e2 <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 f6 42 00 00       	push   $0x42f6
    1660:	e8 6d 22 00 00       	call   38d2 <open>
  ...
  fd = open("lf2", 0);
    ...
    167a:	e8 53 22 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1699:	50                   	push   %eax
    169a:	e8 0b 22 00 00       	call   38aa <read>
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 06 22 00 00       	call   38ba <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 fa 42 00 00       	push   $0x42fa
    16bb:	68 fa 42 00 00       	push   $0x42fa
    16c0:	e8 2d 22 00 00       	call   38f2 <link>
  ...
  unlink("lf2");
    ...
    16d8:	e8 05 22 00 00       	call   38e2 <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 f6 42 00 00       	push   $0x42f6
    16e4:	68 fa 42 00 00       	push   $0x42fa
    16e9:	e8 04 22 00 00       	call   38f2 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1702:	e8 eb 21 00 00       	call   38f2 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1733:	e8 5a 21 00 00       	call   3892 <exit>
    ...
    exit();
    1746:	e8 47 21 00 00       	call   3892 <exit>
    ...
    exit();
    1759:	e8 34 21 00 00       	call   3892 <exit>
    ...
    exit();
    176c:	e8 21 21 00 00       	call   3892 <exit>
    ...
    exit();
    177f:	e8 0e 21 00 00       	call   3892 <exit>
    ...
    exit();
    1792:	e8 fb 20 00 00       	call   3892 <exit>
    ...
    exit();
    17a5:	e8 e8 20 00 00       	call   3892 <exit>
    ...
    exit();
    17b8:	e8 d5 20 00 00       	call   3892 <exit>
    ...
    exit();
    17cb:	e8 c2 20 00 00       	call   3892 <exit>
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  file[2] = '\0';
    ...
    181e:	53                   	push   %ebx
    181f:	e8 ae 20 00 00       	call   38d2 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    182e:	83 c6 01             	add    $0x1,%esi
      close(fd);
    1831:	50                   	push   %eax
    1832:	e8 83 20 00 00       	call   38ba <close>
    1837:	83 c4 10             	add    $0x10,%esp
      wait();
    183a:	e8 5b 20 00 00       	call   389a <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    1852:	e8 8b 20 00 00       	call   38e2 <unlink>
    pid = fork();
    1857:	e8 2e 20 00 00       	call   388a <fork>
    if(pid && (i % 3) == 1){
    ...
    1881:	53                   	push   %ebx
    1882:	e8 4b 20 00 00       	call   38d2 <open>
      if(fd < 0){
    ...
    189d:	e8 4e 21 00 00       	call   39f0 <printf>
        exit();
    18a2:	e8 eb 1f 00 00       	call   3892 <exit>
    ...
    18b9:	e8 34 20 00 00       	call   38f2 <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 cc 1f 00 00       	call   3892 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 11 20 00 00       	call   38f2 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 b1 1f 00 00       	call   389a <wait>
  for(i = 0; i < 40; i++){
  ...
  memset(fa, 0, sizeof(fa));
    ...
    18fa:	6a 00                	push   $0x0
    18fc:	50                   	push   %eax
    18fd:	e8 ee 1d 00 00       	call   36f0 <memset>
  fd = open(".", 0);
    1902:	5f                   	pop    %edi
    1903:	58                   	pop    %eax
    1904:	6a 00                	push   $0x0
    ...
    190e:	e8 bf 1f 00 00       	call   38d2 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 7e 1f 00 00       	call   38aa <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 41 1f 00 00       	call   38ba <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    19ad:	e8 30 1f 00 00       	call   38e2 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 28 1f 00 00       	call   38e2 <unlink>
  ...
  for(i = 0; i < 40; i++){
    19c5:	83 c6 01             	add    $0x1,%esi
      wait();
    19c8:	e8 cd 1e 00 00       	call   389a <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19d8:	e8 ad 1e 00 00       	call   388a <fork>
    if(pid < 0){
    ...
    1a00:	6a 00                	push   $0x0
    1a02:	53                   	push   %ebx
    1a03:	e8 ca 1e 00 00       	call   38d2 <open>
    1a08:	89 04 24             	mov    %eax,(%esp)
    1a0b:	e8 aa 1e 00 00       	call   38ba <close>
      close(open(file, 0));
    1a10:	58                   	pop    %eax
    1a11:	5a                   	pop    %edx
    1a12:	6a 00                	push   $0x0
    1a14:	53                   	push   %ebx
    1a15:	e8 b8 1e 00 00       	call   38d2 <open>
    1a1a:	89 04 24             	mov    %eax,(%esp)
    1a1d:	e8 98 1e 00 00       	call   38ba <close>
      close(open(file, 0));
    1a22:	59                   	pop    %ecx
    1a23:	58                   	pop    %eax
    1a24:	6a 00                	push   $0x0
    1a26:	53                   	push   %ebx
    1a27:	e8 a6 1e 00 00       	call   38d2 <open>
    1a2c:	89 04 24             	mov    %eax,(%esp)
    1a2f:	e8 86 1e 00 00       	call   38ba <close>
      close(open(file, 0));
    1a34:	58                   	pop    %eax
    1a35:	5a                   	pop    %edx
    1a36:	6a 00                	push   $0x0
    1a38:	53                   	push   %ebx
    1a39:	e8 94 1e 00 00       	call   38d2 <open>
    1a3e:	89 04 24             	mov    %eax,(%esp)
    1a41:	e8 74 1e 00 00       	call   38ba <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a71:	e8 7a 1f 00 00       	call   39f0 <printf>
      exit();
    1a76:	e8 17 1e 00 00       	call   3892 <exit>
    ...
    exit();
    1a89:	e8 04 1e 00 00       	call   3892 <exit>
    ...
    1a9a:	e8 51 1f 00 00       	call   39f0 <printf>
        exit();
    1a9f:	e8 ee 1d 00 00       	call   3892 <exit>
    ...
    1ab0:	e8 3b 1f 00 00       	call   39f0 <printf>
        exit();
    1ab5:	e8 d8 1d 00 00       	call   3892 <exit>
      close(fd);
    1aba:	83 ec 0c             	sub    $0xc,%esp
    1abd:	50                   	push   %eax
    1abe:	e8 f7 1d 00 00       	call   38ba <close>
...
00001ad0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1aec:	e8 f1 1d 00 00       	call   38e2 <unlink>
  pid = fork();
    1af1:	e8 94 1d 00 00       	call   388a <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2d:	e8 b0 1d 00 00       	call   38e2 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b62:	e8 6b 1d 00 00       	call   38d2 <open>
    1b67:	89 04 24             	mov    %eax,(%esp)
    1b6a:	e8 4b 1d 00 00       	call   38ba <close>
  ...
  if(pid)
    ...
    wait();
    1b7e:	e8 17 1d 00 00       	call   389a <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bad:	e8 40 1d 00 00       	call   38f2 <link>
    ...
    exit();
    1bc8:	e8 c5 1c 00 00       	call   3892 <exit>
    exit();
    1bcd:	e8 c0 1c 00 00       	call   3892 <exit>
...
00001be0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1bfc:	e8 e1 1c 00 00       	call   38e2 <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 45 44 00 00       	push   $0x4445
    1c0d:	e8 c0 1c 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 8f 1c 00 00       	call   38ba <close>
    ...
    if(link("bd", name) != 0){
    1c57:	e8 96 1c 00 00       	call   38f2 <link>
  ...
  unlink("bd");
    ...
    1c78:	e8 65 1c 00 00       	call   38e2 <unlink>
    ...
    if(unlink(name) != 0){
    1ca2:	e8 3b 1c 00 00       	call   38e2 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cdd:	e8 0e 1d 00 00       	call   39f0 <printf>
      exit();
    1ce2:	e8 ab 1b 00 00       	call   3892 <exit>
    ...
    1cf1:	e8 fa 1c 00 00       	call   39f0 <printf>
      exit();
    1cf6:	e8 97 1b 00 00       	call   3892 <exit>
    ...
    exit();
    1d09:	e8 84 1b 00 00       	call   3892 <exit>
...
00001d10 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d2a:	e8 b3 1b 00 00       	call   38e2 <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 b8 45 00 00 	movl   $0x45b8,(%esp)
    1d36:	e8 bf 1b 00 00       	call   38fa <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d53:	e8 7a 1b 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d6f:	50                   	push   %eax
    1d70:	e8 3d 1b 00 00       	call   38b2 <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 3d 1b 00 00       	call   38ba <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 b8 45 00 00 	movl   $0x45b8,(%esp)
    1d84:	e8 59 1b 00 00       	call   38e2 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9c:	e8 59 1b 00 00       	call   38fa <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db9:	e8 14 1b 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dd5:	50                   	push   %eax
    1dd6:	e8 d7 1a 00 00       	call   38b2 <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 d7 1a 00 00       	call   38ba <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 12 45 00 00       	push   $0x4512
    1dec:	e8 e1 1a 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e0b:	50                   	push   %eax
    1e0c:	e8 99 1a 00 00       	call   38aa <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e2d:	53                   	push   %ebx
    1e2e:	e8 87 1a 00 00       	call   38ba <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	5b                   	pop    %ebx
    1e34:	58                   	pop    %eax
    1e35:	68 52 45 00 00       	push   $0x4552
    1e3a:	68 ee 44 00 00       	push   $0x44ee
    1e3f:	e8 ae 1a 00 00       	call   38f2 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e57:	e8 86 1a 00 00       	call   38e2 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e71:	e8 5c 1a 00 00       	call   38d2 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e89:	e8 74 1a 00 00       	call   3902 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ea1:	e8 5c 1a 00 00       	call   3902 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb9:	e8 44 1a 00 00       	call   3902 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ed1:	e8 2c 1a 00 00       	call   3902 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eeb:	e8 e2 19 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f0a:	50                   	push   %eax
    1f0b:	e8 9a 19 00 00       	call   38aa <read>
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 95 19 00 00       	call   38ba <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	59                   	pop    %ecx
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 ee 44 00 00       	push   $0x44ee
    1f2e:	e8 9f 19 00 00       	call   38d2 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f4b:	e8 82 19 00 00       	call   38d2 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f68:	e8 65 19 00 00       	call   38d2 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f85:	e8 48 19 00 00       	call   38d2 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f9f:	e8 2e 19 00 00       	call   38d2 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb9:	e8 14 19 00 00       	call   38d2 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fd6:	e8 17 19 00 00       	call   38f2 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff3:	e8 fa 18 00 00       	call   38f2 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2010:	e8 dd 18 00 00       	call   38f2 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2028:	e8 cd 18 00 00       	call   38fa <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2040:	e8 b5 18 00 00       	call   38fa <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2058:	e8 9d 18 00 00       	call   38fa <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2070:	e8 6d 18 00 00       	call   38e2 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2088:	e8 55 18 00 00       	call   38e2 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20a0:	e8 5d 18 00 00       	call   3902 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b8:	e8 45 18 00 00       	call   3902 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20d0:	e8 0d 18 00 00       	call   38e2 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e8:	e8 f5 17 00 00       	call   38e2 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2100:	e8 dd 17 00 00       	call   38e2 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2118:	e8 c5 17 00 00       	call   38e2 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2130:	e8 ad 17 00 00       	call   38e2 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2165:	e8 28 17 00 00       	call   3892 <exit>
    ...
    exit();
    2178:	e8 15 17 00 00       	call   3892 <exit>
    ...
    exit();
    218b:	e8 02 17 00 00       	call   3892 <exit>
    ...
    exit();
    219e:	e8 ef 16 00 00       	call   3892 <exit>
    ...
    exit();
    21b1:	e8 dc 16 00 00       	call   3892 <exit>
    ...
    exit();
    21c4:	e8 c9 16 00 00       	call   3892 <exit>
    ...
    exit();
    21d7:	e8 b6 16 00 00       	call   3892 <exit>
    ...
    exit();
    21ea:	e8 a3 16 00 00       	call   3892 <exit>
    ...
    exit();
    21fd:	e8 90 16 00 00       	call   3892 <exit>
    ...
    exit();
    2210:	e8 7d 16 00 00       	call   3892 <exit>
    ...
    exit();
    2223:	e8 6a 16 00 00       	call   3892 <exit>
    ...
    exit();
    2236:	e8 57 16 00 00       	call   3892 <exit>
    ...
    exit();
    2249:	e8 44 16 00 00       	call   3892 <exit>
    ...
    exit();
    225c:	e8 31 16 00 00       	call   3892 <exit>
    ...
    exit();
    226f:	e8 1e 16 00 00       	call   3892 <exit>
    ...
    exit();
    2282:	e8 0b 16 00 00       	call   3892 <exit>
    ...
    exit();
    2295:	e8 f8 15 00 00       	call   3892 <exit>
    ...
    exit();
    22a8:	e8 e5 15 00 00       	call   3892 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    ...
    exit();
    22bb:	e8 d2 15 00 00       	call   3892 <exit>
    ...
    exit();
    22ce:	e8 bf 15 00 00       	call   3892 <exit>
    ...
    exit();
    22e1:	e8 ac 15 00 00       	call   3892 <exit>
    ...
    exit();
    22f4:	e8 99 15 00 00       	call   3892 <exit>
    ...
    exit();
    2307:	e8 86 15 00 00       	call   3892 <exit>
    ...
    exit();
    231a:	e8 73 15 00 00       	call   3892 <exit>
    ...
    exit();
    232d:	e8 60 15 00 00       	call   3892 <exit>
    ...
    exit();
    2340:	e8 4d 15 00 00       	call   3892 <exit>
    ...
    exit();
    2353:	e8 3a 15 00 00       	call   3892 <exit>
    ...
    exit();
    2366:	e8 27 15 00 00       	call   3892 <exit>
    ...
    exit();
    2379:	e8 14 15 00 00       	call   3892 <exit>
    ...
    exit();
    238c:	e8 01 15 00 00       	call   3892 <exit>
    ...
    exit();
    239f:	e8 ee 14 00 00       	call   3892 <exit>
    ...
    exit();
    23b2:	e8 db 14 00 00       	call   3892 <exit>
    ...
    exit();
    23c5:	e8 c8 14 00 00       	call   3892 <exit>
    ...
    exit();
    23d8:	e8 b5 14 00 00       	call   3892 <exit>
    ...
    exit();
    23eb:	e8 a2 14 00 00       	call   3892 <exit>
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2410:	e8 cd 14 00 00       	call   38e2 <unlink>
    ...
    242d:	e8 a0 14 00 00       	call   38d2 <open>
    if(fd < 0){
    ...
    2444:	50                   	push   %eax
    2445:	e8 68 14 00 00       	call   38b2 <write>
      if(cc != sz){
    ...
    245a:	56                   	push   %esi
    245b:	e8 52 14 00 00       	call   38b2 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 44 14 00 00       	call   38ba <close>
    unlink("bigwrite");
    2476:	c7 04 24 b4 47 00 00 	movl   $0x47b4,(%esp)
    247d:	e8 60 14 00 00       	call   38e2 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24af:	e8 3c 15 00 00       	call   39f0 <printf>
        exit();
    24b4:	e8 d9 13 00 00       	call   3892 <exit>
    ...
    24c3:	e8 28 15 00 00       	call   39f0 <printf>
      exit();
    24c8:	e8 c5 13 00 00       	call   3892 <exit>
...
000024d0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24ec:	e8 f1 13 00 00       	call   38e2 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24f1:	58                   	pop    %eax
    24f2:	5a                   	pop    %edx
    24f3:	68 02 02 00 00       	push   $0x202
    24f8:	68 10 48 00 00       	push   $0x4810
    24fd:	e8 d0 13 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 5d 13 00 00       	call   38ba <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 10 48 00 00       	push   $0x4810
    2566:	e8 67 13 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25bb:	56                   	push   %esi
    25bc:	e8 e9 12 00 00       	call   38aa <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 e7 12 00 00       	call   38ba <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 f3 12 00 00       	call   38e2 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2612:	e8 d9 13 00 00       	call   39f0 <printf>
      exit();
    2617:	e8 76 12 00 00       	call   3892 <exit>
    ...
    2626:	e8 c5 13 00 00       	call   39f0 <printf>
      exit();
    262b:	e8 62 12 00 00       	call   3892 <exit>
    ...
    263a:	e8 b1 13 00 00       	call   39f0 <printf>
      exit();
    263f:	e8 4e 12 00 00       	call   3892 <exit>
    ...
    264e:	e8 9d 13 00 00       	call   39f0 <printf>
      exit();
    2653:	e8 3a 12 00 00       	call   3892 <exit>
    ...
    exit();
    2666:	e8 27 12 00 00       	call   3892 <exit>
    ...
    exit();
    2679:	e8 14 12 00 00       	call   3892 <exit>
    ...
    exit();
    268c:	e8 01 12 00 00       	call   3892 <exit>
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26b9:	e8 3c 12 00 00       	call   38fa <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26d1:	e8 24 12 00 00       	call   38fa <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26ee:	e8 df 11 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 b3 11 00 00       	call   38ba <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 68 51 00 00       	push   $0x5168
    2710:	e8 bd 11 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    271f:	50                   	push   %eax
    2720:	e8 95 11 00 00       	call   38ba <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 dc 48 00 00 	movl   $0x48dc,(%esp)
    272c:	e8 c9 11 00 00       	call   38fa <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2740:	e8 b5 11 00 00       	call   38fa <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    276e:	e8 1f 11 00 00       	call   3892 <exit>
    ...
    exit();
    2781:	e8 0c 11 00 00       	call   3892 <exit>
    ...
    exit();
    2794:	e8 f9 10 00 00       	call   3892 <exit>
    ...
    exit();
    27a7:	e8 e6 10 00 00       	call   3892 <exit>
    ...
    exit();
    27ba:	e8 d3 10 00 00       	call   3892 <exit>
    ...
    exit();
    27cd:	e8 c0 10 00 00       	call   3892 <exit>
...
000027e0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    27f9:	e8 fc 10 00 00       	call   38fa <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2811:	e8 ec 10 00 00       	call   3902 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 b4 10 00 00       	call   38e2 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 9c 10 00 00       	call   38e2 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2859:	e8 a4 10 00 00       	call   3902 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 6c 10 00 00       	call   38e2 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 58 10 00 00       	call   38e2 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 44 10 00 00       	call   38e2 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28c7:	e8 c6 0f 00 00       	call   3892 <exit>
    ...
    exit();
    28da:	e8 b3 0f 00 00       	call   3892 <exit>
    ...
    exit();
    28ed:	e8 a0 0f 00 00       	call   3892 <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    ...
    exit();
    2900:	e8 8d 0f 00 00       	call   3892 <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    ...
    exit();
    2913:	e8 7a 0f 00 00       	call   3892 <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    ...
    exit();
    2926:	e8 67 0f 00 00       	call   3892 <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    ...
    exit();
    2939:	e8 54 0f 00 00       	call   3892 <exit>
    ...
    exit();
    294c:	e8 41 0f 00 00       	call   3892 <exit>
...
00002960 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297f:	e8 4e 0f 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 22 0f 00 00       	call   38ba <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 c5 49 00 00 	movl   $0x49c5,(%esp)
    299f:	e8 5e 0f 00 00       	call   3902 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 14 0f 00 00       	call   38d2 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 f7 0e 00 00       	call   38d2 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 07 0f 00 00       	call   38fa <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 d7 0e 00 00       	call   38e2 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 ca 0e 00 00       	call   38f2 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 a2 0e 00 00       	call   38e2 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 78 0e 00 00       	call   38d2 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 5e 0e 00 00       	call   38d2 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 2c 0e 00 00       	call   38b2 <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 24 0e 00 00       	call   38ba <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aba:	e8 d3 0d 00 00       	call   3892 <exit>
    ...
    exit();
    2acd:	e8 c0 0d 00 00       	call   3892 <exit>
    ...
    exit();
    2ae0:	e8 ad 0d 00 00       	call   3892 <exit>
    ...
    exit();
    2af3:	e8 9a 0d 00 00       	call   3892 <exit>
    ...
    exit();
    2b06:	e8 87 0d 00 00       	call   3892 <exit>
    ...
    exit();
    2b19:	e8 74 0d 00 00       	call   3892 <exit>
    ...
    exit();
    2b2c:	e8 61 0d 00 00       	call   3892 <exit>
    ...
    exit();
    2b3f:	e8 4e 0d 00 00       	call   3892 <exit>
    ...
    exit();
    2b52:	e8 3b 0d 00 00       	call   3892 <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b88:	e8 6d 0d 00 00       	call   38fa <mkdir>
    ...
    2ba0:	e8 5d 0d 00 00       	call   3902 <chdir>
  ...
  chdir("/");
    ...
    2c38:	e8 c5 0c 00 00       	call   3902 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c5d:	e8 8e 0d 00 00       	call   39f0 <printf>
      exit();
    2c62:	e8 2b 0c 00 00       	call   3892 <exit>
    ...
    2c71:	e8 7a 0d 00 00       	call   39f0 <printf>
      exit();
    2c76:	e8 17 0c 00 00       	call   3892 <exit>
    2c7b:	90                   	nop
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 d8 0b 00 00       	call   388a <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 d5 0b 00 00       	call   389a <wait>
  ...
  if(wait() != -1){
    2cce:	e8 c7 0b 00 00       	call   389a <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    exit();
    2cff:	e8 8e 0b 00 00       	call   3892 <exit>
      exit();
    2d04:	e8 89 0b 00 00       	call   3892 <exit>
    ...
    2d13:	e8 d8 0c 00 00       	call   39f0 <printf>
      exit();
    2d18:	e8 75 0b 00 00       	call   3892 <exit>
    ...
    exit();
    2d2b:	e8 62 0b 00 00       	call   3892 <exit>
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  a = sbrk(0);
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 9e 0b 00 00       	call   391a <sbrk>
    if(b != a){
  ...
  pid = fork();
    2d98:	e8 ed 0a 00 00       	call   388a <fork>
  if(pid < 0){
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 66 0b 00 00       	call   391a <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 5a 0b 00 00       	call   391a <sbrk>
  if(c != a + 1){
  ...
  wait();
    2dd3:	e8 c2 0a 00 00       	call   389a <wait>
  a = sbrk(0);
    2dd8:	83 ec 0c             	sub    $0xc,%esp
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 38 0b 00 00       	call   391a <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 27 0b 00 00       	call   391a <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 0b 0b 00 00       	call   391a <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2e18:	e8 fd 0a 00 00       	call   391a <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 e7 0a 00 00       	call   391a <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 cc 0a 00 00       	call   391a <sbrk>
    2e4e:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2e50:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e57:	e8 be 0a 00 00       	call   391a <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 a7 0a 00 00       	call   391a <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ec5:	e8 48 0a 00 00       	call   3912 <getpid>
    2eca:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ecc:	e8 b9 09 00 00       	call   388a <fork>
    if(pid < 0){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    wait();
    2ee5:	e8 b0 09 00 00       	call   389a <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2ef8:	50                   	push   %eax
    2ef9:	e8 a4 09 00 00       	call   38a2 <pipe>
    ...
    2f21:	e8 84 09 00 00       	call   38aa <read>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
    2f33:	e8 52 09 00 00       	call   388a <fork>
  ...
  c = sbrk(4096);
    ...
    wait();
    2fa5:	e8 f0 08 00 00       	call   389a <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fbd:	6a 00                	push   $0x0
    2fbf:	e8 56 09 00 00       	call   391a <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fd3:	ff 35 f0 5d 00 00    	pushl  0x5df0
    ...
    2ff4:	ff 35 f0 5d 00 00    	pushl  0x5df0
    2ffa:	e8 f1 09 00 00       	call   39f0 <printf>
      exit();
    2fff:	83 c4 20             	add    $0x20,%esp
    3002:	e8 8b 08 00 00       	call   3892 <exit>
    sbrk(-(sbrk(0) - oldbrk));
    3007:	83 ec 0c             	sub    $0xc,%esp
    300a:	6a 00                	push   $0x0
    300c:	e8 09 09 00 00       	call   391a <sbrk>
    3011:	29 c3                	sub    %eax,%ebx
    3013:	89 1c 24             	mov    %ebx,(%esp)
    3016:	e8 ff 08 00 00       	call   391a <sbrk>
    ...
    3027:	ff 35 f0 5d 00 00    	pushl  0x5df0
    302d:	e8 be 09 00 00       	call   39f0 <printf>
    exit();
    3032:	e8 5b 08 00 00       	call   3892 <exit>
    printf(1, "pipe() failed\n");
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    317e:	6a 00                	push   $0x0
    3180:	e8 9d 07 00 00       	call   3922 <sleep>
    sleep(0);
    3185:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    318c:	e8 91 07 00 00       	call   3922 <sleep>
    kill(pid);
    3191:	89 34 24             	mov    %esi,(%esp)
    3194:	e8 29 07 00 00       	call   38c2 <kill>
    wait();
    3199:	e8 fc 06 00 00       	call   389a <wait>
    if(link("nosuchfile", (char*)p) != -1){
    319e:	58                   	pop    %eax
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 fd 4b 00 00       	push   $0x4bfd
    31a6:	e8 47 07 00 00       	call   38f2 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31c9:	ff 35 f0 5d 00 00    	pushl  0x5df0
    ...
    31dd:	c3                   	ret    
      exit();
    31de:	e8 af 06 00 00       	call   3892 <exit>
      printf(stdout, "link should not succeed\n");
    31e3:	83 ec 08             	sub    $0x8,%esp
    31e6:	68 08 4c 00 00       	push   $0x4c08
    31eb:	ff 35 f0 5d 00 00    	pushl  0x5df0
    31f1:	e8 fa 07 00 00       	call   39f0 <printf>
      exit();
    31f6:	e8 97 06 00 00       	call   3892 <exit>
    31fb:	90                   	nop
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    320b:	ff 35 f0 5d 00 00    	pushl  0x5df0
  ...
  printf(stdout, "bss test ok\n");
    ...
    324b:	ff 35 f0 5d 00 00    	pushl  0x5df0
    ...
    3263:	ff 35 f0 5d 00 00    	pushl  0x5df0
    3269:	e8 82 07 00 00       	call   39f0 <printf>
      exit();
    326e:	e8 1f 06 00 00       	call   3892 <exit>
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    328b:	e8 52 06 00 00       	call   38e2 <unlink>
  pid = fork();
    3290:	e8 f5 05 00 00       	call   388a <fork>
  if(pid == 0){
  ...
  wait();
    32a2:	e8 f3 05 00 00       	call   389a <wait>
  fd = open("bigarg-ok", 0);
    32a7:	83 ec 08             	sub    $0x8,%esp
    32aa:	6a 00                	push   $0x0
    32ac:	68 56 4c 00 00       	push   $0x4c56
    32b1:	e8 1c 06 00 00       	call   38d2 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32c4:	50                   	push   %eax
    32c5:	e8 f0 05 00 00       	call   38ba <close>
  unlink("bigarg-ok");
    32ca:	c7 04 24 56 4c 00 00 	movl   $0x4c56,(%esp)
    32d1:	e8 0c 06 00 00       	call   38e2 <unlink>
}
    ...
    32f7:	ff 35 f0 5d 00 00    	pushl  0x5df0
    args[MAXARG-1] = 0;
    ...
    3324:	ff 35 f0 5d 00 00    	pushl  0x5df0
    ...
    333b:	e8 92 05 00 00       	call   38d2 <open>
    close(fd);
    3340:	89 04 24             	mov    %eax,(%esp)
    3343:	e8 72 05 00 00       	call   38ba <close>
    exit();
    3348:	e8 45 05 00 00       	call   3892 <exit>
    printf(stdout, "bigarg test failed!\n");
    334d:	50                   	push   %eax
    334e:	50                   	push   %eax
    334f:	68 96 4c 00 00       	push   $0x4c96
    3354:	ff 35 f0 5d 00 00    	pushl  0x5df0
    335a:	e8 91 06 00 00       	call   39f0 <printf>
    exit();
    335f:	e8 2e 05 00 00       	call   3892 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3364:	52                   	push   %edx
    3365:	52                   	push   %edx
    3366:	68 7d 4c 00 00       	push   $0x4c7d
    336b:	ff 35 f0 5d 00 00    	pushl  0x5df0
    3371:	e8 7a 06 00 00       	call   39f0 <printf>
    exit();
    3376:	e8 17 05 00 00       	call   3892 <exit>
    337b:	90                   	nop
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    342a:	50                   	push   %eax
    342b:	e8 a2 04 00 00       	call   38d2 <open>
    if(fd < 0){
    ...
    344f:	57                   	push   %edi
    3450:	e8 5d 04 00 00       	call   38b2 <write>
      if(cc < 512)
    ...
    3472:	e8 43 04 00 00       	call   38ba <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3519:	50                   	push   %eax
    351a:	e8 c3 03 00 00       	call   38e2 <unlink>
  while(nfiles >= 0){
...
00003550 <uio>:
{
  ...
  pid = fork();
    3562:	e8 23 03 00 00       	call   388a <fork>
  if(pid == 0){
  ...
  wait();
    3570:	e8 25 03 00 00       	call   389a <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35a8:	e8 e5 02 00 00       	call   3892 <exit>
    printf (1, "fork failed\n");
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    ...
    exit();
    35bb:	e8 d2 02 00 00       	call   3892 <exit>
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35ce:	e8 ff 02 00 00       	call   38d2 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35df:	6a 00                	push   $0x0
    35e1:	e8 34 03 00 00       	call   391a <sbrk>
    35e6:	83 c4 0c             	add    $0xc,%esp
    35e9:	83 e8 01             	sub    $0x1,%eax
    35ec:	6a ff                	push   $0xffffffff
    35ee:	50                   	push   %eax
    35ef:	53                   	push   %ebx
    35f0:	e8 b5 02 00 00       	call   38aa <read>
  close(fd);
    35f5:	89 1c 24             	mov    %ebx,(%esp)
    35f8:	e8 bd 02 00 00       	call   38ba <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3621:	e8 6c 02 00 00       	call   3892 <exit>
    3626:	8d 76 00             	lea    0x0(%esi),%esi
    3629:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00003630 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3630:	69 05 ec 5d 00 00 0d 	imul   $0x19660d,0x5dec,%eax
    3637:	66 19 00 
{
    363a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3643:	a3 ec 5d 00 00       	mov    %eax,0x5dec
}
    3648:	c3                   	ret    
...
strcmp(const char *p, const char *q)
{
    ...
    3688:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  while(*p && *p == *q)
    368b:	0f b6 02             	movzbl (%edx),%eax
    368e:	0f b6 19             	movzbl (%ecx),%ebx
    3691:	84 c0                	test   %al,%al
    3693:	74 22                	je     36b7 <strcmp+0x37>
    3695:	38 d8                	cmp    %bl,%al
    3697:	74 0d                	je     36a6 <strcmp+0x26>
    3699:	eb 1e                	jmp    36b9 <strcmp+0x39>
    369b:	90                   	nop
    369c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    36a0:	38 d8                	cmp    %bl,%al
    36a2:	89 f1                	mov    %esi,%ecx
    36a4:	75 13                	jne    36b9 <strcmp+0x39>
    p++, q++;
    36a6:	83 c2 01             	add    $0x1,%edx
  while(*p && *p == *q)
    36a9:	0f b6 02             	movzbl (%edx),%eax
    p++, q++;
    36ac:	8d 71 01             	lea    0x1(%ecx),%esi
  while(*p && *p == *q)
    36af:	0f b6 59 01          	movzbl 0x1(%ecx),%ebx
    36b3:	84 c0                	test   %al,%al
    36b5:	75 e9                	jne    36a0 <strcmp+0x20>
    36b7:	31 c0                	xor    %eax,%eax
  return (uchar)*p - (uchar)*q;
    36b9:	29 d8                	sub    %ebx,%eax
}
    36bb:	5b                   	pop    %ebx
    36bc:	5e                   	pop    %esi
    36bd:	5d                   	pop    %ebp
